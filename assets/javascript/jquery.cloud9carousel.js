...
;(function($) {
  ...
  var Item = function( element, options ) {
    ...
    this.element.style.transition = "opacity .65s";
    ...
    this.moveTo = function( x, y, scale ) {
      ...
      if (style.zIndex > 57 && style.zIndex <= 75) {
        style.opacity = .65;
      } else if (style.zIndex > 50 && style.zIndex <= 57) {
        style.opacity = .3;
      } else if (style.zIndex > 1 && style.zIndex <= 50) {
        style.opacity = .1;
      } else {
        style.opacity = 1;
      }
